    ...
    <div className="navbar">
      <div className="navbar--container">
        ...
        <NavLink to="/" smooth={true} spy="true" duration={2000}>
          <div>
            <span className={classes.drawerLinks} style={{color:"black"}}>Home</span>
          </div>
        </NavLink>
        <NavLink to="/#about" smooth={true} spy="true" duration={2000}>
          <div>
            <span className={classes.drawerLinks} style={{color:"black"}}>About</span>
          </div>
        </NavLink>
        <NavLink to="/#skills" smooth={true} spy="true" duration={2000}>
          <div>
            <span className={classes.drawerLinks} style={{color:"black"}}>Skills</span>
          </div>
        </NavLink>
        <NavLink to="/#projects" smooth={true} spy="true" duration={2000}>
          <div>
            <span className={classes.drawerLinks} style={{color:"black"}}>Projects</span>
          </div>
        </NavLink>
        <NavLink to="/#blog" smooth={true} spy="true" duration={2000}>
          <div>
            <span className={classes.drawerLinks} style={{color:"black"}}>GitHub</span>
          </div>
        </NavLink>
        <NavLink to="/#contacts" smooth={true} spy="true" duration={2000}>
          <div>
            <span className={classes.drawerLinks} style={{color:"black"}}>Contact</span>
          </div>
        </NavLink>
        </div>
      ...
      >
        ...
        <div onClick={handleDrawerClose}>
          <div className="navLink--container" style={{overflow:"auto"}}>
            <Fade left>
              <NavLink to="/" smooth={true} spy="true" duration={2000}>
            ...
            {/* <Fade left>
                            ...
                            >
                                <div className={classes.drawerItem}>
                                    <GiGraduateCap className={classes.drawerIcon} />
            ...
            <Fade left>
              <NavLink to="/#projects" smooth={true} spy="true" duration={2000}>
                <div className={classes.drawerItem}>
                  <GiEarthAmerica className={classes.drawerIcon} />
